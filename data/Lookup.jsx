...
export default {
  ...
  SIGNIN_HEADING: 'Continue With WebVerse',
  SIGNIN_SUBHEADING: 'To use WebVerse you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using WebVerse, you agree to the collection of usage data for analytics.',
